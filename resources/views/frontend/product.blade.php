								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/5.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/6.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/7.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/8.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/9.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/10.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/11.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/12.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/13.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/14.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/15.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('details')}}"><img src="{{asset('frontend/images/16.png')}}" alt=" " class="img-responsive" /></a>
